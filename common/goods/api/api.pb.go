...
// source: easymarket-go-server/common/goods/api/api.proto
...
func init() {
	proto.RegisterFile("easymarket-go-server/common/goods/api/api.proto", fileDescriptor_0a7aecac4e359b73)
}
...
var _Goods_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "easymarket-go-server/common/goods/api/api.proto",
}
